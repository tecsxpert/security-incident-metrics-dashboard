...
def generate_report():
    ...
    try:
        ...
        logger.error(f"POST /generate-report — Groq call failed: {str(e)}")
        return jsonify({"error": "AI service unavailable", "message": "Failed to get response from AI model", "status": 503}), 503
